...
class path_planner:
	...
	def followPath(self, path, robo_pose):
		...
		next_pose.position.y = 0
		heading1 = math.atan2(robo_pose.pose.position.y-next_pose.position.y, robo_pose.pose.position.x-next_pose.position.x)
		heading2 = math.atan2(robo_pose.pose.position.y-next_pose.position.y, robo_pose.pose.position.x-next_pose.position.x) - 1.5707
		heading3 = math.atan2(robo_pose.pose.position.y-next_pose.position.y, robo_pose.pose.position.x-next_pose.position.x) + 1.5707
		heading4 = math.atan2(robo_pose.pose.position.y-next_pose.position.y, robo_pose.pose.position.x-next_pose.position.x) - 3.1415
		print("robot pose: "+str(robo_pose.pose.orientation.z))
		print("heading: "+str(math.sin(heading1/2)))
		print("heading + 90: "+str(math.sin(heading2/2)))
		print("heading - 90: "+str(math.sin(heading3/2)))
		print("heading + 180: "+str(math.sin(heading4/2)))
